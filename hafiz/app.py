...
def create_app():
    ...
    with app.app_context():
        from . import models
        from .views import reciter_data_bp, surah_number_bp, ayah_variation_bp, word_variation_bp
        from .views import surah_name_bp
        app.register_blueprint(reciter_data_bp)
        app.register_blueprint(surah_number_bp)
        app.register_blueprint(surah_name_bp)
